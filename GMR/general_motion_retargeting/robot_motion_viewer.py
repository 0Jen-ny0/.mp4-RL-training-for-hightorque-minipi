...
def draw_frame(
    ...
    for i in range(3):
        ...
        if joint_name is not None and i == 0:
...
class RobotMotionViewer:
    ...
    def step(self, 
        ...
        # align human pelvis to robot base for visualization only
        if "pelvis" in human_motion_data:
            human_pelvis_pos = human_motion_data["pelvis"][0]
            robot_base_pos = self.data.xpos[self.model.body(self.robot_base).id]
            human_pos_offset = robot_base_pos - human_pelvis_pos
